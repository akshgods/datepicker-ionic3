    ...
    function m(f, c) {
        ...
        n.init = function(a) {
            ka = i({
                ...
                // console.log('a.lang: ',a.lang,' p.lang: ',p.lang,' a: ',a,' p: ',p);
                // Aa = wa.i18n[a.lang || p.lang]; //ganesh comment original code
            Aa = wa.i18n[a.lang || a.lang];
            i(c, a);
...
(function(a) {
    ...
    var m = a.mobiscroll,
        ...
        monthNamesEs: "Enero,Febrero,Marzo,Abril,Mayo,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre".split(","),
        ...
        A = function(d) {
            ...
            if (J.match(/date/i)) {
                ...
                for (o = 0; 3 > o; o++)
                    ...
                    //ganesh cod change success
                    var langCode= localStorage.getItem('langCode');
                    if(langCode=='es')
                    {
                        for (b = 0; 12 > b; b++) A = c.replace(/[dy]/gi, "").replace(/mm/, 9 > b ? "0" + (b + 1) : b + 1).replace(/m/, b + 1),
                        r.push(b), x.push(A.match(/MM/) ? A.replace(/MM/, '<span class="dw-mon">' + i.monthNamesEs[b] + "</span>") : A.replace(/M/, '<span class="dw-mon">' + i.monthNamesShort[b] + "</span>"));
                    }else{
                        for (b = 0; 12 > b; b++) A = c.replace(/[dy]/gi, "").replace(/mm/, 9 > b ? "0" + (b + 1) : b + 1).replace(/m/, b + 1),
